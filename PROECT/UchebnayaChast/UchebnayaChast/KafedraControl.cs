...
namespace UchebnayaChast
{
    public partial class KafedraControl : UserControl
    {
        ...
        private void BtnFncChange_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenForm(new FormAddChange(Functional.Controller.TakeRowWithNamesById(SpecialSqlController.Tables.kafedra, int.Parse(Functional.GetId(KafedraGrid)))));
                Actions();
            }
        }
